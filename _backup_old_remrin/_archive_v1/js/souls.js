...
const characters = [
    ...
    { id: 'volt', name: 'Volt', file: 'volt.json', voice: SOUL_CARTRIDGES.volt.VOICE_ID, hero_standing: repoUrl + 'volt_hero_standing.png' + rawSuffix, bg: repoUrl + 'volt_bg.jpg' + rawSuffix, avatar: repoUrl + 'volt_hero_standing.png' + rawSuffix },
