...
import { AudioAnalytics } from "@/components/studio/AudioAnalytics"
import { AudioAnalyticsWidget } from "@/components/admin/mission-control/AudioWidget"
import { IconChartBar } from "@tabler/icons-react"

// Using local JSON for the manifest and state for now as they are generated by the audit
import FEATURE_MANIFEST from "@/lib/admin/data/feature_manifest.json"

export default function MissionControlPage() {
    const [activeTab, setActiveTab] = useState<'map' | 'docs' | 'triage' | 'audio'>('map')
            ...
            <div className="min-h-screen bg-rp-base text-rp-text pb-20">
                ...
                <main className="mx-auto max-w-7xl p-6">
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        {activeTab === 'audio' && <AudioAnalytics />}
                    </div>
                </main>
            </div>
        </AdminPasswordGate>
