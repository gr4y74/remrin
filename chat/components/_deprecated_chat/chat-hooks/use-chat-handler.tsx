...
export const useChatHandler = () => {
  ...
  const handleSendMessage = useCallback(async (
    ...
    try {
      ...
      console.log("🔍 [Chat] Looking for model:", chatSettings?.model)
      console.log("🔍 [Chat] Found modelData:", modelData ? `${modelData.modelId} (${modelData.provider})` : "NOT FOUND")
      console.log("🔍 [Chat] LLM_LIST has", LLM_LIST.length, "models, first 3:", LLM_LIST.slice(0, 3).map(m => m.modelId))
