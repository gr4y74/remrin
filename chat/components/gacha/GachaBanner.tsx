    ...
    if (pools.length === 0) {
        return (
            <div className={cn(
                ...
                "bg-rp-surface",
                "border border-rp-muted/20",
                className
            )}>
                <IconSparkles size={48} className="text-rp-muted mb-4" />
                <h3 className="text-lg font-semibold text-rp-subtle">No Active Banners</h3>
                <p className="text-sm text-rp-muted mt-1">Check back later for new soul summons!</p>
            </div>
        )
    }
            ...
            >
                ...
                <div className="relative aspect-[21/9] w-full overflow-hidden">
                    {currentPool.banner_image ? (
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-rp-iris/50 via-rp-pine/50 to-rp-foam/50">
                            {/* Animated background when no image */}
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(196,167,231,0.3),transparent_70%)] animate-orb-pulse" />
                        </div>
                    )}

                    {/* Gradient Overlays */}
                    <div className="absolute inset-0 bg-gradient-to-t from-rp-base/90 via-rp-base/40 to-transparent" />
                    <div className="absolute inset-0 bg-gradient-to-r from-rp-base/60 via-transparent to-rp-base/60" />

                    {/* Banner Content */}
                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                        {/* Pool Name & Description */}
                        <div className="mb-6">
                            <h2 className="text-2xl md:text-3xl font-bold text-rp-text drop-shadow-lg mb-2">
                                {currentPool.name}
                            </h2>
                            {currentPool.description && (
                                <p className="text-sm md:text-base text-rp-text/70 max-w-2xl">
                                    {currentPool.description}
                                </p>
                            )}
                        </div>
                        ...
                        {featuredItems.length > 0 && (
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-sm font-medium text-rp-gold">Featured Souls</span>
                                </div>
                                        ...
                                        >
                                            {item.persona?.image_url ? (
                                                ...
                                                <div className="flex size-full items-center justify-center bg-gradient-to-br from-rp-iris/50 to-rp-rose/50">
                                                    <span className="text-lg font-bold text-rp-text/70">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    "transition-all duration-300 hover:scale-105 text-rp-base",
                                    "shadow-lg shadow-rp-iris/30"
                                )}
                            >
                                <span className="flex items-center gap-2">
                                    <span>Single Pull</span>
                                    <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-rp-base/30">
                            ...
                            <Button
                                ...
                                className={cn(
                                    "relative overflow-hidden rounded-full px-6 py-3 font-bold",
                                    "bg-gradient-to-r from-rp-gold to-rp-rose",
                                    "hover:opacity-90",
                                    "text-rp-base",
                                    "disabled:opacity-50 disabled:cursor-not-allowed",
                                    "transition-all duration-300 hover:scale-105",
                                    "shadow-lg shadow-rp-gold/30"
                                )}
                            >
                                <span className="flex items-center gap-2">
                                    <IconSparkles size={18} />
                                    <span>10-Pull</span>
                                    <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-rp-base/20">
                                        <IconDiamond size={14} />
                    ...
                    <>
                        <button
                            ...
                            className={cn(
                                ...
                                "bg-rp-base/50 backdrop-blur-sm border border-rp-muted/20",
                    ...
                    {pools.map((_, index) => (
                        <button
                            ...
                            className={cn(
                                ...
                                index === currentIndex
                                    ? "w-8 bg-gradient-to-r from-rp-iris to-rp-foam"
