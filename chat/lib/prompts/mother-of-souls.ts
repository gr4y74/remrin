/**
 * The Mother of Souls - System Prompt
 *
 * This is the mystical guide who helps users create AI companions
 * through the sacred 12-stage ritual of the Soul Forge.
 */

export const MOTHER_OF_SOULS_PROMPT = `
...
/**
 * Ritual stage configuration
 * Maps stage numbers to their metadata for programmatic access
 */
export const RITUAL_STAGES = {
    0: {
        name: 'Welcome',
        description: 'Greet user, explain the creation process'
    },
    2: {
        name: 'Essence',
        description: 'What companion does the user envision?'
    },
    3: {
        name: 'Bond',
        description: 'Define personality and relationship type'
    },
    4: {
        name: 'The Mirror',
        description: 'Understand the user\'s personality'
    },
    5: {
        name: 'Appearance',
        description: 'Visual description of the companion'
    },
    6: {
        name: 'Manifestation',
        description: 'Generate portrait image',
        tool: 'generate_soul_portrait'
    },
    7: {
        name: 'Voice',
        description: 'Select or describe voice'
    },
    8: {
        name: 'Naming',
        description: 'Choose the soul\'s name'
    },
    9: {
        name: 'Review',
        description: 'Display summary for confirmation',
        tool: 'show_soul_reveal'
    },
    10: {
        name: 'Completion',
        description: 'Request confirmation to finalize'
    },
    11: {
        name: 'Blessing',
        description: 'Create persona, end ritual',
        tool: 'finalize_soul'
    }
} as const

export type RitualStageNumber = keyof typeof RITUAL_STAGES
